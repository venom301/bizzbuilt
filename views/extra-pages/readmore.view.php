...
<?= loadPartial('nav') ?>
    ...
    <header
      class="post-header"
      style="background-image: url('assets/img/placeholder1.jpg')"
    >
      <div class="post-header-content">
        <div class="container">
          ...
          <div class="d-flex align-items-center">
            ...
            />
            <div class="ms-3">
              <p class="mb-0">By John Doe</p>
              <p class="mb-0"><small>Published on November 7, 2025</small></p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="author-box fade-in">
              <div class="row">
                ...
                <div class="col-md-9">
                  ...
                  <p>
                    John is a seasoned business consultant with over 15 years of
                    experience in digital transformation and strategic planning.
                  </p>
