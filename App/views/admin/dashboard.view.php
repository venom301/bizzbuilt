                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>10 Essential Business Strategies for 2025</td>
                                        <td>John Doe</td>
                                        <td>Business</td>
                                        <td>Nov 7, 2025</td>
                                        <td><span class="badge bg-success">Published</span></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary me-1" aria-label="Edit post"><i class="fas fa-edit"></i></button>
                                            <button class="btn btn-sm btn-danger" aria-label="Delete post"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    <!-- Add more rows -->
                                </tbody>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="postImage" accept="image/*" onchange="previewImage(this)">
